...
public class NestRadioGroup  extends LinearLayout {
     ...
     * <p>
     *
     * See {@link ＃LinearLayout_Layout LinearLayout
     *
    ...
    private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == NestRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == NestRadioGroup.this && child instanceof ViewGroup) {
