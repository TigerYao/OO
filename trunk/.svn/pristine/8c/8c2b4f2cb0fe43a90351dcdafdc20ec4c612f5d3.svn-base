...
public class Base64 {
    ...
    public static String encodeBytes(byte[] source) {
        return encodeBytes(source, 0, source.length, NO_OPTIONS).replace("\r\n", "").replace("\n", "");
    }
...
//                System.out.println("" + source[srcOffset + 3] + ": " + (DECODABET[source[srcOffset + 3]]));
    ...
    public static String decodeString2String(String s){
        if (s == null || s.equals("")) {
            return "";
        }
        try {
    ...
    public static String encodeString2String(String s){
        if (s == null) {
            return "";
        }
        s = s.trim();
        ...
        return Base64.encodeBytes(s.getBytes()).replace("\r\n", "").replace("\n", "");// .replace("\n", "");
    }
}
