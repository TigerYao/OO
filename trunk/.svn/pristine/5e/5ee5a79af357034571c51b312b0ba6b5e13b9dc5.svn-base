...
public class WhoRentMeOrIRentAdapter extends BaseAdapter { private ArrayList<MyTask> mList;
    ...
    public WhoRentMeOrIRentAdapter(Context context) {
    ...
    public void refreshAndNotifyData(List<MyTask> beanList, int typeId) {
        mTypeId = typeId;
        mList.clear();
